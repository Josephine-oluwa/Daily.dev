        ...
        <div className="w-full flex justify-center items-center h-[100vh]" >
            <form
                ...
                <div className="flex flex-col items-center mb-8" >
                    <img className="w-[150px] h-[150px] rounded-[50%] object-cover border-4  bg-yellow-300  "
                        src={avatar}
                    />
                    <label className="py-2 px-4 my-2 bg-yellow-300 text-black rounded-md hover:scale-[1.02] hover:cursor-pointer duration-300 transition-all "
                        htmlFor="image"
                ...
                {/*  Button  starts */}
                <button className="py-3 px-4 my-2 bg-yellow-300 text-black rounded hover:scale-[1.02] hover:cursor-pointer duration-300 transition-all flex justify-center border border-purple-950 "
                    type="submit"
                >Register</button>
                ...
                <div className="flex flex-col items-center w-[300px] text-[12px] " >
                    ...
                    <Link to="/sign-in" >
                        <span className="font-bold text-black hover:cursor-pointer decoration-none " >Please Sign in here</span>
                    </Link>
                </div>
            </form>
